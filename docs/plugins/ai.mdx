...
:::info
**This plugin is hosted by the [Botkube Cloud](https://app.botkube.io) plugin repository and requires active Botkube Cloud account. The AI Assistant usage quota depends on a selected Botkube Cloud plan.**
:::
